...
- 域名DNS解析
    ...
    ![image_godaddy_0](docs/img/Snipaste_2025-02-03_14-55-07.png)
...
- <b>Github Pages</b> 申请
    ...
    ![image_github_0](docs/img/Snipaste_2025-02-03_15-10-31.png)

    - 填入刚刚所购买的域名到下方 <b>Custom domain</b> 处，可先退出，等待DNS传播后勾选 <b>Enforces HTTPS</b>，如下图

    ![image_github_1](docs/img/Snipaste_2025-02-03_15-14-22.png)
